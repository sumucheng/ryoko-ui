    ...
    (function () {
      if (module.hot) {
        ...
        if (api.compatible) {
          module.hot.accept();
          if (!module.hot.data) {
            api.createRecord('$6d9288', $6d9288);
          } else {
            api.reload('$6d9288', $6d9288);
          }
        }
...
exports.default = _default;
  ...
  return _c(
    "button",
    {
      ...
      class: [_vm.type, _vm.size, _vm.plain && "plain"],
    ...
    (function () {
      if (module.hot) {
        ...
        if (api.compatible) {
          module.hot.accept();
          if (!module.hot.data) {
            api.createRecord('$ae748a', $ae748a);
          } else {
            api.reload('$ae748a', $ae748a);
          }
        }
    ...
    (function () {
      if (module.hot) {
        ...
        if (api.compatible) {
          module.hot.accept();
          if (!module.hot.data) {
            api.createRecord('$172dfc', $172dfc);
          } else {
            api.reload('$172dfc', $172dfc);
          }
        }
...
exports.default = _default;
  ...
  return _c(
    "div",
    { staticClass: "col", class: _vm.colClassList, style: _vm.colStyle },
    [_vm._t("default")],
    2
  )
}
    ...
    (function () {
      if (module.hot) {
        ...
        if (api.compatible) {
          module.hot.accept();
          if (!module.hot.data) {
            api.createRecord('$efb8d3', $efb8d3);
          } else {
            api.reload('$efb8d3', $efb8d3);
          }
        }
...
exports.default = _default;
  ...
  return _c(
    "div",
    { staticClass: "layout", class: _vm.classList },
    [_vm._t("default")],
    2
  )
}
    ...
    (function () {
      if (module.hot) {
        ...
        if (api.compatible) {
          module.hot.accept();
          if (!module.hot.data) {
            api.createRecord('$cbf2a1', $cbf2a1);
          } else {
            api.reload('$cbf2a1', $cbf2a1);
          }
        }
...
exports.default = _default;
  ...
  return _c(
    "div",
    { staticClass: "header", style: "height:" + _vm.height },
    [_vm._t("default")],
    2
  )
}
    ...
    (function () {
      if (module.hot) {
        ...
        if (api.compatible) {
          module.hot.accept();
          if (!module.hot.data) {
            api.createRecord('$b60513', $b60513);
          } else {
            api.reload('$b60513', $b60513);
          }
        }
...
exports.default = _default;
  ...
  return _c(
    "div",
    { staticClass: "footer", style: "height:" + _vm.height },
    [_vm._t("default")],
    2
  )
}
    ...
    (function () {
      if (module.hot) {
        ...
        if (api.compatible) {
          module.hot.accept();
          if (!module.hot.data) {
            api.createRecord('$282387', $282387);
          } else {
            api.reload('$282387', $282387);
          }
        }
...
exports.default = _default;
  ...
  return _c(
    "div",
    { staticClass: "sider", style: "width:" + _vm.width },
    [_vm._t("default")],
    2
  )
}
    ...
    (function () {
      if (module.hot) {
        ...
        if (api.compatible) {
          module.hot.accept();
          if (!module.hot.data) {
            api.createRecord('$053624', $053624);
          } else {
            api.reload('$053624', $053624);
          }
        }
    ...
    (function () {
      if (module.hot) {
        ...
        if (api.compatible) {
          module.hot.accept();
          if (!module.hot.data) {
            api.createRecord('$7e3736', $7e3736);
          } else {
            api.reload('$7e3736', $7e3736);
          }
        }
...
exports.default = _default;
  ...
  return _c(
    "div",
    { staticClass: "toast", class: _vm.type },
    [
      _c("Icon", { attrs: { name: _vm.type } }, [
    ...
    (function () {
      if (module.hot) {
        ...
        if (api.compatible) {
          module.hot.accept();
          if (!module.hot.data) {
            api.createRecord('$1ed31a', $1ed31a);
          } else {
            api.reload('$1ed31a', $1ed31a);
          }
        }
...
},{"./icon":"src/icon.vue","_css_loader":"node_modules/parcel-bundler/src/builtins/css-loader.js","vue-hot-reload-api":"node_modules/vue-hot-reload-api/dist/index.js","vue":"node_modules/vue/dist/vue.common.js"}],"src/plugin.js":[function(require,module,exports) {
"use strict";
...
_vue.default.component('r-button', _button.default);

_vue.default.component('r-row', _row.default);

_vue.default.component('r-col', _col.default);

_vue.default.component('r-grid', Grid);

_vue.default.component('r-layout', _layout.default);

_vue.default.component('r-header', _header.default);

_vue.default.component('r-footer', _footer.default);

_vue.default.component('r-sider', _sider.default);

_vue.default.component('r-content', _content.default);

_vue.default.component('r-toast', _toast.default);

new _vue.default({
  el: '#app'
});
},{"vue":"node_modules/vue/dist/vue.common.js","./button":"src/button.vue","./row":"src/row.vue","./col":"src/col.vue","./layout":"src/layout.vue","./header":"src/header.vue","./footer":"src/footer.vue","./sider":"src/sider.vue","./content":"src/content.vue","./toast":"src/toast.vue","./plugin":"src/plugin.js"}],"node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
